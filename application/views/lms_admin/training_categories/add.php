...
<div id="page_content">
			...
			<div class="md-card-content large-padding">
				<div id="infoMessage"><?php echo $message;?></div>
					<?php echo form_open(uri_string(),array('class'=>'uk-form-stacked'));?>
							...
							<?php
							if(isset($lms_training_category_id)){
								echo form_hidden('id', $lms_training_category_id);
							}
							?>
 ...
 <div class="md-fab-wrapper">
        <a class="md-fab md-fab-accent md-fab-wave" href="<?php echo base_url('lmsadmin/classroom/trainingcategories');?>">
