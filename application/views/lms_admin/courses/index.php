...
<div id="page_content">
                ...
                <div class="md-card-content">
                    ...
                    <table id="dt_tableExport" class="uk-table" cellspacing="0" width="100%">
                        ...
                        <tr>
                            ...
                            <th><?php echo lang('index_com_stand_th', 'com_standard');?></th>
                            <th><?php echo lang('def_status', 'status');?></th>
                            <th><?php echo lang('index_cpd_points', 'cdp pints');?></th>
                            <th><?php echo $this->lang->line('def_action');?></th>
                        </tr>
                        </thead>
                        ...
                        <tr>
                            ...
                            <td><?php echo $crow['cpd_points'];?></td>
														<td class="uk-text-nowrap">
																<a href="<?php echo base_url('lmsadmin/elearning/updatecourse/').$crow['lms_course_id'];?>"><i class="md-icon material-icons"></i></a>
 ...
 <div class="md-fab-wrapper">
        <a class="md-fab md-fab-accent md-fab-wave" href="<?php echo base_url('lmsadmin/elearning/addcourses');?>">
