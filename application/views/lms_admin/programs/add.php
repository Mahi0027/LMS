...
<div id="page_content">
					...
					<div class="uk-grid" data-uk-grid-margin>
									<div class="uk-width-medium-1-1">
											<div class="parsley-row">
													<label for="val_select" class="uk-form-label"><?php echo lang('training_categories', 'training_categories');?><span class="req">*</span></label>
							...
							<div class="uk-grid" data-uk-grid-margin>
									<div class="uk-width-medium-1-1">
											<div class="parsley-row">
													<label for="fullname"><?php echo lang('index_program_name_th', 'name');?><span class="req">*</span></label>
							...
							<?php
							if(isset($lms_program_id)){
								echo form_hidden('id', $lms_program_id);
							}
							?>
 ...
 <div class="md-fab-wrapper">
        <a class="md-fab md-fab-accent md-fab-wave" href="<?php echo base_url('lmsadmin/classroom/programs');?>">
