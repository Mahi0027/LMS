...
<div id="page_content">
   ...
   <div class="md-card uk-margin-medium-bottom">
                <div class="md-card-content">
                    ...
                    <table id="dt_tableExport" class="uk-table" cellspacing="0" width="100%">
                        <thead>
                        <tr>
														<th><?php echo lang('v_name', 'name');?></th>
														<th><?php echo lang('v_description', 'name');?></th>
														<th><?php echo lang('v_site_location', 'name');?></th>
														<th><?php echo lang('v_facility_type', 'name');?></th>
                            <th><?php echo lang('v_cost', 'name');?></th>
                            <th><?php echo lang('v_seat_limit', 'desc');?></th>                            
                        ...
                        <tr>
                            ...
                            <td><?php echo $row['description'];?></td>
														...
														<td><?php if($row['facility_type']=='i'){ echo 'Internal';}else{echo 'External';}?></td>
														<td><?php echo $row['cost'];?></td>
														<td><?php echo $row['seat_limit'];?></td>
														
														<td class="uk-text-nowrap">
																<a href="<?php echo base_url('lmsadmin/configration/update_venues/').$row['lms_venue_id'];?>"><i class="md-icon material-icons"></i></a>
 ...
 <div class="md-fab-wrapper">
        <a class="md-fab md-fab-accent md-fab-wave" href="<?php echo base_url('lmsadmin/configration/addvenues');?>">
