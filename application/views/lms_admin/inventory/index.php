...
<div id="page_content">
   ...
   <div class="md-card uk-margin-medium-bottom">
                <div class="md-card-content">
                    ...
                    <table id="dt_tableExport" class="uk-table" cellspacing="0" width="100%">
                        <thead>
                        <tr>
                            <th><?php echo lang('index_inventory_name_th', 'name');?></th>
                        ...
                        <tr>
                            <td><?php echo $row['inventory_name'];?></td>                        
														...
														<td class="uk-text-nowrap">
																<a href="<?php echo base_url('lmsadmin/configration/updateinventory/').$row['lms_inventory_id'];?>"><i class="md-icon material-icons"></i></a>
 ...
 <div class="md-fab-wrapper">
        <a class="md-fab md-fab-accent md-fab-wave" href="<?php echo base_url('lmsadmin/configration/addinventory');?>">
