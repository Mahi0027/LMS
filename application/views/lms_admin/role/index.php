...
<div id="page_content">
   ...
   <div class="md-card uk-margin-medium-bottom">
                <div class="md-card-content">
                    ...
                    <table id="dt_tableExport" class="uk-table" cellspacing="0" width="100%">
                        <thead>
                        <tr>
                            <th><?php echo lang('lms_role_id', 'Role Id');?></th>
                            <th><?php echo lang('lms_role_name', 'Role Name');?></th>
                        ...
                        <tbody>
												...
												?>
                        <tr>
                            <td><?php echo $row['lms_role_id'];?></td>
                            <td><?php echo $row['lms_role_name'];?></td>
 ...
 <div class="md-fab-wrapper">
        <a class="md-fab md-fab-accent md-fab-wave" href="<?php echo base_url('lmsadmin/users/add_roles');?>">
