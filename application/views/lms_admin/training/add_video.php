                ...
                <div class="md-card-content">
                    <table id="dt_tableExport" class="uk-table" cellspacing="0" width="100%">
                        ...
                        <tr>
                            ...
                            <td><a href="<?php echo base_url('lmsadmin/elearning/add_video_to_training_assign/'.$url.'/'.$vrow['lms_video_id']);?>"><?php echo '<i class="md-icon material-icons md-color-light-blue-600 md-24">add</i>'?></a></td>
                        </tr>
                        <?php endforeach;
												endif;
												?>
