                    ...
                    <table id="dt_tableExport" class="uk-table" cellspacing="0" width="100%">
                        <thead>
                            <tr>
                                ...
                                <th><?php echo lang('index_refname_th', 'reference name');?></th>
                                <th><?php echo lang('index_objective_th', 'objective');?></th>
                                <th><?php echo lang('index_seat_time_th', 'seat_time');?></th>
                        ...
                        <tbody>
							<?php if($detail):
							foreach($detail as $crow):
							?>
                            <tr>
                                <td><?php echo $crow['name'];?></td>
                                <td><?php echo $crow['reference_title'];?></td>
                                <td><?php echo $crow['objectives'];?></td>
                                <td><?php echo $crow['seat_time'];?></td>
                                <td><?php echo $crow['description'];?></td>
                                <td><?php echo $crow['status_id'];?></td>
                                <td><?php echo $crow['cpd_points'];?></td>
                                <td><?php echo $crow['created_at'];?></td>
                                <td><?php echo $crow['created_by'];?></td>
                                <td><?php echo $crow['updated_at'];?></td>
                                <td><?php echo $crow['updated_by'];?></td>
                            </tr>
                        <?php endforeach;
												endif;
												?>
