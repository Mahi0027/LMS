                    ...
                    <table id="dt_tableExport" class="uk-table" cellspacing="0" width="100%">
                        <thead>
                            <tr>
                                ...
                                <th><?php echo lang('index_duration_th', 'duration');?></th>
                                <th><?php echo lang('index_max_score_th', 'max score');?></th>
                                <th><?php echo lang('index_passing_th','passing');?></th>
                                <th><?php echo lang('index_cpd_point_th', 'cpd_point');?></th>
                                <th><?php echo lang('index_instruction_th', 'instruction');?></th>
                                <th><?php echo lang('index_document_th', 'document');?></th>
