   ...
   <div class="md-card uk-margin-medium-bottom">
                <div class="md-card-content">
                    <table id="dt_tableExport" class="uk-table" cellspacing="0" width="100%">
                        <thead>
                            <tr>
                                <th><?php echo lang('index_username_th', 'username');?></th>
                                <th><?php echo lang('index_email_th', 'email');?></th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a href="<?php echo base_url('lmsadmin/classroom/add_user_into_user_id_table/'.$lms_training_id.'/'.$lms_sessions_id.'/'.$lms_batch_id.'/'.$row['id']);?>"><?php echo '<i class="md-icon material-icons md-color-light-blue-600 md-24">add</i>'?></a></td>
                            </tr>
                        <?php endforeach;
												endif;
												?>
