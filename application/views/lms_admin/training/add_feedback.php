                    ...
                    <table id="dt_tableExport" class="uk-table" cellspacing="0" width="100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a href="<?php echo base_url('lmsadmin/elearning/add_feedback_to_training_assign/'.$url.'/'.$row['lms_feedback_id']);?>"><?php echo '<i class="md-icon material-icons md-color-light-blue-600 md-24">add</i>'?></a></td>
                            </tr>
                        <?php endforeach;
												endif;
												?>
