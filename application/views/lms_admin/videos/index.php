...
<div id="page_content">
                    ...
                    <table id="dt_tableExport" class="uk-table" cellspacing="0" width="100%">
                        ...
                        <tr>
                            ...
                            <td>
														...
														?></td>
                            <td><?php echo $vrow['cpd_points'];?></td>
														<td class="uk-text-nowrap">
																<a href="<?php echo base_url('lmsadmin/elearning/updatevideo/').$vrow['lms_video_id'];?>"><i class="md-icon material-icons"></i></a>
 ...
 <div class="md-fab-wrapper">
        <a class="md-fab md-fab-accent md-fab-wave" href="<?php echo base_url('lmsadmin/elearning/addvideo');?>">
