...
<div id="page_content">
   ...
   <div class="md-card uk-margin-medium-bottom">
                <div class="md-card-content">
                    ...
                    <table id="dt_tableExport" class="uk-table" cellspacing="0" width="100%">
                        <thead>
                        <tr>
                            <th><?php echo lang('index_name', 'name');?></th>
                            <th><?php echo lang('index_description', 'desc');?></th>
                            <th><?php echo lang('index_type', 'type');?></th>
                            <th><?php echo lang('index_url', 'url');?></th>
                            <th><?php echo lang('index_document', 'document');?></th>
                            <th><?php echo lang('index_instructor', 'instructor');?></th>
                            <th><?php echo lang('index_status', 'status');?></th>
                            <th><?php echo lang('index_cpd_points', 'cpd');?></th>
                        ...
                        <tbody>
												<?php if($reference_material_list):
												foreach($reference_material_list as $row):
												?>
                        <tr>
							...
							<td class="uk-text-nowrap">
                                 <a href="<?php echo base_url('lmsadmin/elearning/update_reference_material/').$row['reference_id'];?>"><i class="md-icon material-icons"></i></a>
 ...
 <div class="md-fab-wrapper">
        <a class="md-fab md-fab-accent md-fab-wave" href="<?php echo base_url('lmsadmin/elearning/add_reference_material');?>">
