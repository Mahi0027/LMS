...
<div id="page_content">
   ...
   <div class="md-card uk-margin-medium-bottom">
                <div class="md-card-content">
                    ...
                    <table id="dt_tableExport" class="uk-table" cellspacing="0" width="100%">
                        <thead>
                        <tr>
                            <th><?php echo lang('session_id', 'session_id');?></th>
                            <th><?php echo lang('session_name', 'desc');?></th>
                            <th><?php echo lang('objective', 'objective');?></th>
                        ...
                        <tr>
                            <th><?php echo lang('session_id', 'session_id');?></th>
                            <th><?php echo lang('session_name', 'name');?></th>
                            <th><?php echo lang('objective', 'objective');?></th>
                            <th><?php echo lang('index_cpd_points', 'cdp pints');?></th>
                            <th><?php echo lang('def_action','action');?></th>
                        </tr>
                        ...
                        <tbody>
												...
												?>
                        <tr>
														<td><?php echo $row['lms_sessions_id'];?></td>
                            <td><?php echo $row['name'];?></td>
                            <td><?php echo $row['objective'];?></td>
														<td><?php echo $row['cpd_points'];?></td>                            
														<td class="uk-text-nowrap">
																<a href="<?php echo base_url('lmsadmin/classroom/updatesession/').$row['lms_sessions_id'];?>"><i class="md-icon material-icons"></i></a>
 ...
 <div class="md-fab-wrapper">
        <a class="md-fab md-fab-accent md-fab-wave" href="<?php echo base_url('lmsadmin/classroom/addsession');?>">
