...
<div id="page_content">
							...
							<div class="uk-grid" data-uk-grid-margin>
									<div class="uk-width-medium-1-1">
											<div class="parsley-row">
													<label for="fullname"><?php echo lang('vt_name', 'name');?><span class="req">*</span></label>
													 <?php echo form_input($vendor_type);?>
 ...
 <div class="md-fab-wrapper">
        <a class="md-fab md-fab-accent md-fab-wave" href="<?php echo base_url('lmsadmin/configration/vendortype');?>">
