...
<div id="page_content">
   ...
   <div class="md-card uk-margin-medium-bottom">
                <div class="md-card-content">
                    ...
                    <table id="dt_tableExport" class="uk-table" cellspacing="0" width="100%">
                        <thead>
                        <tr>
                            <th><?php echo lang('vt_name', 'name');?></th>
                        ...
                        <tbody>
												<?php if($vendor_type):
												foreach($vendor_type as $row):
												?>
                        <tr>
                            <td><?php echo $row['vendor_type'];?></td>                        
														 <td><?php echo $row['description'];?></td>
														<td class="uk-text-nowrap">
																<a href="<?php echo base_url('lmsadmin/configration/updatevendortype/').$row['lms_vendor_type_id'];?>"><i class="md-icon material-icons"></i></a>
 ...
 <div class="md-fab-wrapper">
        <a class="md-fab md-fab-accent md-fab-wave" href="<?php echo base_url('lmsadmin/configration/addvendortype');?>">
